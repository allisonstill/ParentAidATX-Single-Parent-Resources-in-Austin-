...
const governmentProgramCardData = [
    ...
    { id: 2, title: "Child Care Assistance Program (CCAP)", description: "this is the second card", image: "/house-pic.jpg" },
    { id: 3, title: "Supplemental Nutrition Assistance Program (SNAP)", description: "this is the third card", image: "/house-pic.jpg" },
  ];
